...
CDAP ships with a set of built-in Sources, Sinks and Transforms as described `here <http://docs.cask.co/cdap/3.3.6/en/cdap-apps/hydrator/index.html>`__
which can be used to create Batch ETL Applications and Real-time ETL Applications right out of the box.

Note: If you want to create your own Source and Sink, you can find more instructions on how to do that `here <http://docs.cask.co/cdap/3.3.6/en/cdap-apps/hydrator/custom.html>`__.
